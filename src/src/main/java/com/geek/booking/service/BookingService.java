...
public interface BookingService {
    ...
    BookingCreationResult createBooking(BookingCreateRequest request, Long userId);
    ...
    BookingResponse  updateBookingStatus(Long bookingId, String newStatus, Long adminId);
}